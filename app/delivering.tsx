...
export default function DeliveringScreen() {
    ...
    const fetchDirections = async () => {
        ...
        const destinationLatLng = `${currentOrder.deliveryLat},${currentOrder.deliveryLng}`;
        ...
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 32, paddingHorizontal: 15, paddingVertical: 10 }}>
                <View style={{ flexGrow: 1, gap: 8 }}>
                    ...
                    <Text style={{ color: '#333', fontWeight: 'bold' }}>{currentOrder?.customeraddress}</Text>
                </View>
                <View style={{ gap: 8 }}>
            ...
            >
                ...
                <Marker coordinate={{ latitude: currentOrder.deliveryLat, longitude: currentOrder.deliveryLng }} title={'Customer'} pinColor="blue" >
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 15, paddingVertical: 12, marginBottom: 16 }}>
                <View style={{ flexGrow: 1, gap: 8 }}>
                    <Text style={{ color: '#333', fontWeight: 'bold' }}>{currentOrder?.customername}</Text>
                    <Text style={{ color: '#333', fontSize: 16 }}>{currentOrder?.customerphone}</Text>
                </View>
                <IconButton
                    text=''
                    icon='phone'
